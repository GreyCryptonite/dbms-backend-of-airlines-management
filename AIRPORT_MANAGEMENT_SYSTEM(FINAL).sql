...
INSERT INTO CITY  VALUES('BENGALURU','KARNATAKA','India');
...
INSERT INTO AIRPORT VALUES('KEMPEGOWDA INTERNATIONAL AIRPORT','KARNATAKA','India','BENGALURU');
...
INSERT INTO AIRLINE VALUES  VALUES('AA','American Airlines','001');
...
INSERT INTO AIRLINE VALUES ('SJ','SPICE Jet Airways','007');
...
INSERT INTO CONTAINS VALUES('AI','KEMPEGOWDA INTERNATIONAL AIRPORT');
INSERT INTO CONTAINS VALUES('AI','George Bush Intercontinental Airport');

INSERT INTO CONTAINS  VALUES('LH','KEMPEGOWDA INTERNATIONAL AIRPORT');
...
INSERT INTO CONTAINS  VALUES('BA','KEMPEGOWDA INTERNATIONAL AIRPORT');
...
INSERT INTO CONTAINS  VALUES('QR','KEMPEGOWDA INTERNATIONAL AIRPORT');
...
INSERT INTO FLIGHT VALUES('AI2014','BLR','DFW','02:10','03:15','On-time','24hr','Connecting',3,1,'AI');


INSERT INTO FLIGHT VALUES('QR2305','BLR','DFW','13:00','13:55','Delayed','21hr','Non-stop',0,0,'QR');


INSERT INTO FLIGHT VALUES('EY1234','JFK','TPA','19:20','20:05','On-time','16hrs','Connecting',5,2,'EY');


INSERT INTO FLIGHT VALUES('LH9876','JFK','BLR','05:50','06:35','On-time','18hrs','Non-stop',0,0,'LH');


INSERT INTO FLIGHT VALUES('BA1689','FRA','DEL','10:20','10:55','On-time','14hrs','Non-stop',0,0,'BA');


INSERT INTO FLIGHT VALUES('AA4367','SFO','FRA','18:10','18:55','On-time','21hrs','Non-stop',0,0,'AA');


INSERT INTO FLIGHT VALUES('SJ1902','IXC','IAH','22:00','22:50','Delayed','28hrs','Non-stop',5,1,'SJ');

INSERT INTO FLIGHT VALUES('SJ007','BLR','IAH','12:00','20:50','On-time','8hrs','Non-stop',1,1,'SJ');

INSERT INTO FLIGHT VALUES('BA3056','BLR','DFW','02:15','02:55','On-time','29hrs','Connecting',3,1,'BA');


INSERT INTO FLIGHT VALUES('EK3456','BLR','SFO','18:50','19:40','On-time','30hrs','Non-stop',0,0,'EK');


INSERT INTO FLIGHT VALUES('9W2334','IAH','DEL','23:00','13:45','On-time','23hrs','Direct',0,0,'9W');
...
INSERT INTO PASSENGER2(PASSPORTNO,FNAME,M,LNAME,ADDRESS,PHONE,AGE,SEX)
VALUES('J9801235','AKHILESH','D','JOSHI','345 CHATHAM COURTS, APT 678, BENGALURU, INDIA',9080369290,29,'M');
...
INSERT INTO PASSENGER2(PASSPORTNO,FNAME,M,LNAME,ADDRESS,PHONE,AGE,SEX)
VALUES('R8990566','RIA','T','GUPTA','3355 PALENCIA, APT 2065, BENGALURU, INDIA',4724512343,10,'M');
...
INSERT INTO EMPLOYEE1(SSN, FNAME, M, LNAME, ADDRESS, PHONE, AGE, SEX, JOBTYPE, ASTYPE, ETYPE, SHIFT, POSITION, AP_NAME)
VALUES(453453453,'RAJ','B','SHARMA','345 FLOYDS, BENGALURU,INDIA',4326789031, 35, 'M','AIRPORT AUTHORITY','','','','MANAGER','KEMPEGOWDA INTERNATIONAL AIRPORT');
...
VALUES(0011234111122,'BLR','DFW','11-MAY-16','','15-DEC-16','32A','ECONOMY',1,'A1234568');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(0984567222299,'JFK','BLR','11-JUN-16','10-DEC-16','20-DEC-16','45D','ECONOMY',2,'B9876541');
...
INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(2206543545545,'BLR','DFW','11-NOV-16','','12-FEB-17','43B','ECONOMY',6,'B8765430');
...
INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(1579283997799,'BLR','SFO','22-JAN-16','','15-DEC-16','38A','ECONOMY',10,'S1243269');
...
INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(1258776199490,'BLR','DFW','13-MAY-16','25-MAY-16','15-DEC-16','37C','ECONOMY',13,'P3452390');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(5891155114477,'FRA','DEL','26-JUN-16','','23-DEC-16','55C','ECONOMY',14,'W7543336');

INSERT INTO TICKET1(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO)
VALUES(5893069766787,'BLR','DFW','11-AUG-16','','22-DEC-16','33F','ECONOMY',15,'R8990566');
...
VALUES('11-MAY-16','BLR','DFW','ECONOMY',95000);

INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('11-JUN-16','JFK','BLR','ECONOMY',100000);
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('11-NOV-16','BLR','DFW','ECONOMY',125000);
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('22-JAN-16','BLR','SFO','ECONOMY',45000);
...
INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('13-MAY-16','BLR','DFW','ECONOMY',65000);

INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('26-JUN-16','FRA','DEL','ECONOMY',80000);

INSERT INTO TICKET2(DATE_OF_BOOKING, SOURCE, DESTINATION, CLASS, PRICE) 
VALUES('11-AUG-16','BLR','DFW','ECONOMY',98000);
...
VALUES('AI127','BLR','DFW','02:10','03:15','Delayed','24hr','Connecting',3,1,'AI');
